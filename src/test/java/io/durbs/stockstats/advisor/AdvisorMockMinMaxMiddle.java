...
public class AdvisorMockMinMaxMiddle {
    ...
    public void setUp() {
        ...
        prices.add(new Price(LocalDate.now().minusDays(5), 20.00));
        prices.add(new Price(LocalDate.now().minusDays(4), 2.00));
        prices.add(new Price(LocalDate.now().minusDays(3), 1.99));
        prices.add(new Price(LocalDate.now().minusDays(2), 8.99));
        prices.add(new Price(LocalDate.now().minusDays(1), 7.29));
    ...
    public void calculationCorrect() {
        ...
        assertThat(appleAdvise.getSingleShareProfit()).isEqualTo(7);
    }
